...
In order to generate a payment link we will access the `linkbuilder` URL. Just add `/linkbuilder` to the public URL generated by Demeter. ie: `https://3000-romantic-birthday-gdqoy8.us1.demeter.run/linkbuilder`.
